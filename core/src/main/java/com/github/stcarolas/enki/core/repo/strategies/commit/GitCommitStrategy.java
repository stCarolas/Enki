...
public class GitCommitStrategy implements Function<String, Try<RevCommit>> {
	...
	protected Function1<File, Try<Git>> git = 
		Function( dir ->
			Try(() -> Git.open(dir))
				.onFailure( 
	...
	protected Function1<Git, Boolean> isClean = 
		Function( git ->
			Try(git.status()::call)
				.onFailure( 
					error -> log.error("error while getting git status: {}", error)
	...
	protected Function1<Git, Try<Git>> stage = 
		Function( git ->
	...
	protected Function2<String, Git, Try<RevCommit>> commit = 
